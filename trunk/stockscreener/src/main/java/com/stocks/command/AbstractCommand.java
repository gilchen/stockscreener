...
public abstract class AbstractCommand implements Command{
	...
	protected static final String GOOGLE_CHART_RECOMMENDED_BUY_URL = "http://~NUM.chart.apis.google.com/chart?cht=lc&chs=700x200&chd=t:~DATA&chg=0,0,1,0&chds=~MIN,~MAX&chm=";
