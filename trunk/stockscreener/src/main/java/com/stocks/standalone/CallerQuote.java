...
public class CallerQuote {
	...
	final static String[] CNBC_ETF_LIST = {".DJIA", ".SPX", "COMP", ".FTSE", ".FCHI", ".GDAXI", "-", "AGQ", "FTR", "BBRY", "SDOW", "UNG", "UPL", "ACI", "DMND", "ANR", "TVIX", "UVXY", "SID", "NBG", "ETRM", "MCP", "WLT", "ARR", "VELT", "VOLC", "-", "OIBR" };
