...
public class CallerQuote {
	...
	final static String[] GOOGLE_ETF_LIST = {"INDEXDJX:.DJI", "INDEXSP:.INX", "INDEXNASDAQ:.IXIC", "INDEXFTSE:.FTSE", "INDEXEURO:PX1", "-", "AGQ", "BAL", "FTR", "NFLX", "RIMM", "SDOW", "UNG", "UPL", "ACI", "DMND", "ANR", "CTRP", "BVSN", "TVLYQ", "SAPX", "TVIX", "ATPG", "UVXY", "AONE", "-", "ERX", "UCO", "-", "UGL", "INDL", "STP" };
	...
	final static String[] CNBC_ETF_LIST = {".DJIA", ".SPX", "COMP", ".FTSE", ".FCHI", ".GDAXI", "-", "AGQ", "BAL", "FTR", "NFLX", "RIMM", "SDOW", "UNG", "UPL", "ACI", "DMND", "ANR", "CTRP", "BVSN", "TVLYQ", "SAPX", "TVIX", "ATPAQ", "UVXY", "AONE", "-", "ERX", "UCO", "CLCV1", "-", "UGL", "INDL", "STP" };
