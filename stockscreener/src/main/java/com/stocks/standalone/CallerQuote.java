...
public class CallerQuote {
	...
	final static String[] CNBC_ETF_LIST = {".DJIA", ".SPX", "COMP", ".FTSE", ".FCHI", ".GDAXI", "-", "AA", "AVP", "CSC", "ECA", "FTR", "MCP", "RIMM", "S", "AGQ", "BAL", "NFLX", "SDOW", "ACI", "-", "ERX", "UCO", "CLCV1", "-", "UGL", "INDL", "NLR", "PCX" }; // "BAL", "LIT", "UCO", "NLR", "TMF", "RIG", "CREE", "ECA", 
	//final static String[] CNBC_ETF_LIST = {"BTU", "CNX", "ANR", "AHGP", "ACI"}; //{"LVS", "MGM", "CCL", "RCL"};
